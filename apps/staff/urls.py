...
from .views import StaffViewSet, BarberSignupAPIView, BarberScheduleViewSet, BarbershopViewSet, SocialAuthAPIView, BarberTelegramLinkAPIView
...
urlpatterns = [
    ...
    path("staff/telegram-link/", BarberTelegramLinkAPIView.as_view(), name="barber-telegram-link"),
